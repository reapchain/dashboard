  ...
  return {
          ...
          case "cosmos-sdk/TextProposal": {
            ...
            any_content = any_1.Any.fromPartial({
              ...
              value: gov_1.TextProposal.encode(
                gov_1.TextProposal.fromPartial({
                  title: title,
    ...
    "/ibc.applications.transfer.v1.MsgTransfer": {
      ...
      toAmino: ({
        ...
        return {
          ...
          timeout_height: timeoutHeight
            ? {
                revision_height:
                  (_a = omitDefault(timeoutHeight.revisionHeight)) === null ||
                  _a === void 0
                    ? void 0
                    : _a.toString(),
                revision_number:
                  (_b = omitDefault(timeoutHeight.revisionNumber)) === null ||
                  _b === void 0
                    ? void 0
                    : _b.toString(),
              }
            : {},
          timeout_timestamp:
            (_c = omitDefault(timeoutTimestamp)) === null || _c === void 0
              ? void 0
              : _c.toString(),
        };
      },
      fromAmino: ({
        ...
        timeoutHeight: timeout_height
          ...
          : undefined,
        timeoutTimestamp: long_1.default.fromString(
          timeout_timestamp || "0",
          true
        ),
      }),
    ...
    "/osmosis.gamm.v1beta1.MsgSwapExactAmountIn": {
      ...
      toAmino: ({ sender, routes, tokenIn, tokenOutMinAmount }) => {
        ...
        return {
          sender,
          routes: routes.map(({ poolId, tokenOutDenom }) => ({
            pool_id: poolId,
      ...
      fromAmino: ({ sender, routes, token_in, token_out_min_amount }) => ({
        sender,
        routes: routes.map(({ pool_id, token_out_denom }) => ({
          poolId: long_1.default.fromString(pool_id),
...
class AminoTypes {
  constructor({ additions = {}, prefix = "cosmos" } = {}) {
    ...
    this.register = Object.assign(
      Object.assign({}, filteredDefaultTypes),
      additions
    );
  }
