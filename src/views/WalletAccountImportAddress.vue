<template>
  <div>
            ...
            <b-col v-if="accounts" md="12">
              <b-form-group label="Public Key" label-for="ir">
                ...
                >
                  <b-form-input
                    id="ir"
                    :value="accounts ? accounts[0].pubkey.key : ''"
                    readonly
                    :state="errors.length > 0 ? false : null"
                  />
                  <small class="text-danger">{{ errors[0] }}</small>
                      ...
                      >
                        ...
                        >
                          ...
                          <span
                            ...
                            "
                          >
                            {{ item.chain_name }} - {{ item.coin_type }}</span
                          >
                        </b-form-checkbox>
                      </b-col>
                    </b-row>
          ...
          <b-col cols="12">
            <b-input-group class="mb-25">
              <b-input-group-prepend is-text>
                <b-avatar :src="''" size="18" variant="light-primary" rounded />
              </b-input-group-prepend>
              <b-form-input
                readonly
                :value="accounts ? accounts[0].address : ''"
              />
              <!-- <b-form-input :value="accounts.address" /> -->
            </b-input-group>
          </b-col>
    ...
    <!-- <b-alert variant="secondary" :show="!accounts">
  ...
  methods: {
    ...
    formSubmitted() {
      ...
      if (!this.$store.state.chains.defaultWallet) {
        this.updateDefaultWallet(this.name);
      }
