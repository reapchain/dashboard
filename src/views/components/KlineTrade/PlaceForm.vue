<template>
  <div>
    <b-card bg-variant="light-secondary" text-variant="black">
      ...
      <div class="d-flex justify-content-between mt-1">
        ...
        <span
          >{{ price }}&nbsp;<small class="text-muted mx-10"
            >{{ target }} ≈</small
          >&nbsp;1&nbsp;<small class="text-muted mx-10"> {{ base }}</small
          >&nbsp;</span
        >
      </div>
      <div class="d-flex justify-content-between mt-1">
    ...
    <b-form-group>
      <div class="d-flex justify-content-between">
        <span>Volume</span>
        <span>
          <small v-if="localPrice > 0" class="text-muted mr-1"
            >≈${{ localPrice }}</small
          >
          <feather-icon
    ...
    <b-form-group>
      ...
      <b-button v-else to="/wallet/import" block variant="primary">
        Connect Wallet
      </b-button>
    </b-form-group>
    <b-alert
    ...
    <b-alert class="mt-2" variant="danger" show>
...
export default {
  ...
  methods: {
    ...
    async sendTx() {
      const tokenOutDenom = this.pool.poolAssets[this.type === 0 ? 0 : 1].token
        .denom;
