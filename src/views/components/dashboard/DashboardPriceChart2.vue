    ...
    <b-row>
      <b-col md="4">
        ...
        <div>
          ...
          >
            <b-dropdown id="dropdown-3" size="sm" text="Pairs" :variant="color">
              <b-dropdown-header>
              ...
              >
                ...
                >
                  <b-row style="width:400px;">
                    ...
                    <b-col cols="4" class="text-uppercase text-truncate">
            ...
            <div class="text-truncate ml-1">
              ...
              <sub class="text-body"
                ><small>/ {{ selectedTicker.target }}</small></sub
              >
            </div>
          </div>
          <!--/ buy  -->
...
export default {
  ...
  computed: {
    ...
    twitter() {
      if (this.coinInfo.links) {
        return this.coinInfo.links.twitter_screen_name
          ? `https://twitter.com/${this.coinInfo.links.twitter_screen_name}`
          : "#";
      }
      return "#";
    },
    ...
    github() {
      if (this.coinInfo.links) {
        ...
        return "https://github.com/reapchain";
      }
      return "#";
    },
  },
