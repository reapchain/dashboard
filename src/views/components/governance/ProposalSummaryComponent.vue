<template>
  <b-card>
    <b-card-title class="mb-0" style="min-height:55px;">
      #{{ p.id }}.
    ...
    <div>
      <div class="scale">
        <div class="box">
          <b-progress
            :max="
              totalPower && p.status === 2
                ? 100 * (totalPower / p.tally.total)
                : 100
            "
            height="2rem"
            class="mb-2"
          ...
          <div
            ...
            class="box overlay"
            :style="
              `left:${Number(tallyParam.quorum) * 100}%; border-color:black`
            "
          />
        </div>
